...
describe('BagFooter.tsx', () => {
  ...
  it('should use the correct UR address', () => {
    ...
    expect(getURAddress(SupportedChainId.MAINNET)).toBe(UNIVERSAL_ROUTER_ADDRESS(SupportedChainId.MAINNET))
    expect(getURAddress(SupportedChainId.MAINNET, 'test_nft_ur_address')).toBe('test_nft_ur_address')
    expect(getURAddress(SupportedChainId.OPTIMISM)).toBe(UNIVERSAL_ROUTER_ADDRESS(SupportedChainId.OPTIMISM))
