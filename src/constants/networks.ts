...
export const RPC_URLS = {
  ...
  [SupportedChainId.BNB]: [QUICKNODE_BNB_RPC_URL, ...FALLBACK_URLS[SupportedChainId.BNB]],
  [SupportedChainId.AVALANCHE]: [
    `https://avalanche-mainnet.infura.io/v3/${INFURA_KEY}`,
    ...FALLBACK_URLS[SupportedChainId.AVALANCHE],
  ],
  [SupportedChainId.BASE]: [`https://base-mainnet.infura.io/v3/${INFURA_KEY}`, ...FALLBACK_URLS[SupportedChainId.BASE]],
}
