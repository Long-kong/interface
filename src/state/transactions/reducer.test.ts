...
describe('transaction reducer', () => {
  ...
  describe('cancelTransaction', () => {
    it('replaces original tx with a cancel tx', () => {
      ...
      const originalTx = store.getState()[SupportedChainId.MAINNET]?.['0x0']
      store.dispatch(
        cancelTransaction({
          chainId: SupportedChainId.MAINNET,
          hash: '0x0',
      ...
      expect(Object.keys(store.getState())).toEqual([String(SupportedChainId.MAINNET)])
      expect(Object.keys(store.getState()[SupportedChainId.MAINNET] ?? {})).toEqual(['0x1'])

      const cancelTx = store.getState()[SupportedChainId.MAINNET]?.['0x1']
